						<ul class="nav nav-tabs">
										<li role="presentation" class=""><a href="/admin/exchange-office/">exchange-office</a></li>
										<li role="presentation" class=""><a href="/admin/exchange-office/new">New itemy</a></li>
							</ul>
						<div class="page">
			...
			<?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="pull-left">price in credits</label>
  ...
  <option value="money" <?php if($c[0]['dbfield'] == 'money'){ echo "selected"; }?> >money</option>
  <option value="safe"  <?php if($c[0]['dbfield'] == 'safe'){ echo"selected"; }?> >safe</option>
  <option value="health"  <?php if($c[0]['dbfield'] == 'health'){ echo"selected"; }?> >health</option>
  ...
  <option value="garagespots">Garage spots</option>
			...
			foreach($c as $f){?>
                        ...
                        <tr>
                            ...
                            <td>
                                [<a href="/admin/exchange-office/edit/?id=<?= $f['id'];?>">Edit</a>] 
                                [<a href="/admin/exchange-office/delete/?id=<?= $f['id'];?>">Delete</a>]
                            </td>
                        </tr>
