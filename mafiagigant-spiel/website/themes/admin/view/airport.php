						<ul class="nav nav-tabs">
										<li role="presentation" class=""><a href="/admin/airport/">Airports</a></li>
										<li role="presentation" class=""><a href="/admin/airport/settings">general settings</a></li>
							</ul>
						<div class="page">
			...
			foreach($c as $f){?>
                        ...
                        <tr>
                            ...
                            <td>
                                [<a href="/admin/countrys/edit/?id=<?= $f['id'];?>">Edit</a>] 
                                [<a href="/admin/countrys/delete/?id=<?= $f['id'];?>">Delete</a>]
                            </td>
                        </tr>
