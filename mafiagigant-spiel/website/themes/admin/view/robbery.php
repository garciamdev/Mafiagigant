						<ul class="nav nav-tabs">
										<li role="presentation" class=""><a href="/admin/robbery/">Robbery</a></li>
										<li role="presentation" class=""><a href="/admin/robbery/new">New robbery</a></li>
							</ul>
						<div class="page">
                ...
                <div class="text-center">
                    <p> Are you sure you want to delete this robbery?</p>
			...
			<?php } ?>
                    ...
                    <button class="btn btn-danger" name="submit" type="submit" value="delete">Yes delete this robbery</button>
                </div>
            </form>
            <?php
            ...
            <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">Min. for successful robbery</label>
                            <input type="number" class="form-control" name="minreceive" value="<?= $c[0]['minreceive'];?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">Max. for successful robbery</label>
                            <input type="number" class="form-control" name="maxreceive" value="<?= $c[0]['maxreceive'];?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">min. health damage</label>
                            <input type="number" class="form-control" name="minhealth" value="<?= $c[0]['minhealth'];?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">max. health damage</label>
                            <input type="number" class="form-control" name="maxhealth" value="<?= $c[0]['maxhealth'];?>">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">Max. for successful robbery</label>
                            <input type="number" class="form-control" name="maxreceive" value="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">min. health damage</label>
                            <input type="number" class="form-control" name="minhealth" value="">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">max. health damage</label>
                            <input type="number" class="form-control" name="maxhealth" value="">
                        </div>
                    </div>
			...
			foreach($c as $f){?>
                        ...
                        <tr>
                            ...
                            <td>
                                [<a href="/admin/robbery/edit/?id=<?= $f['id'];?>">Edit</a>] 
                                [<a href="/admin/robbery/delete/?id=<?= $f['id'];?>">Delete</a>]
                            </td>
                        </tr>
