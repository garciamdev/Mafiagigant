						<ul class="nav nav-tabs">
										<li role="presentation" class=""><a href="/admin/drugs/">Drugs</a></li>
										<li role="presentation" class=""><a href="/admin/drugs/new">New drugs</a></li>
							</ul>
						<div class="page">
			...
			<?php } ?>
                    ...
                    <button class="btn btn-danger" name="submit" type="submit" value="delete">Yes delete this drug</button>
                </div>
            </form>
            <?php
			...
			foreach($c as $f){?>
                        ...
                        <tr>
                            ...
                            <td>
                                [<a href="/admin/drugs/edit/?id=<?= $f['id'];?>">Edit</a>] 
                                [<a href="/admin/drugs/delete/?id=<?= $f['id'];?>">Delete</a>]
                            </td>
                        </tr>
